...
import { getCollectionWithQuery, getDocument } from '../utils/firestoreService';
...
export const useProposals = (currentUserUid: string | null): ProposalsHookResult => {
  ...
  const fetchProposals = async () => {
    ...
    try {
      ...
      const proposalsFromUserProposal = userProposalData.map((userProposal: DocumentData) => {
        const proposal: UserProposalData = {
          ...
          invitedUsers: userProposal.invitedUsers || userProposal.invited_users || [],
